...
def calc_lc(tt, param_list, svd_mag_model=None, svd_lbol_model=None, mag_ncoeff=None, lbol_ncoeff=None):
...
def sn_lc(tt, z, Ebv, abs_mag=-19., regularize_band='sdssu'):
    ...
    model = sncosmo.Model(source='nugent-hyper')
    model.set(z=z)
