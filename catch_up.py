...
dataDirectory = "/home/cough052/shared/ztfrest/candidates/partnership"
dataFolders = [f.name for f in os.scandir(dataDirectory) if f.is_dir()]

fitDirectory = "/home/cough052/shared/ztfrest/candidate_fits"
...
for folder in unfitData:
    subprocess.run("python /home/cough052/barna314/nmma_fitter/make_jobs.py -d "  + folder, shell=True, capture_output=True)