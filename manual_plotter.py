...
parser.add_argument("--posterior", type=str, default='./outdir/tomasInjection/tomasInjection_posterior_samples.dat', help="Path to posterior samples")
